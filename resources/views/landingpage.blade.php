            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="text-center text-white">
                        <!-- Page heading-->
                        <h1 class="mb-5" style="font-size: 3rem;">Order<span
                                style="color: rgba(229, 175, 16, 1);">in</span></h1>
                        <hr style="border-top: 3px solid black; width: 100%; margin-top: 10px; margin-bottom: 30px;">
                        <h4 class="mb-5">Happy with delicious food</h4>
                        <p>Happy with delicious food and get new experiences in our Cafe</p>
                    </div>
                    <!-- Signup form-->
                    <!-- * * * * * * * * * * * * * * *-->
